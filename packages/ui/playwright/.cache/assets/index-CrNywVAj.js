...
const _home_runner_work_megazord_ui_megazord_ui_packages_ui_src_components_button_Button = () => __vitePreload(() => import('./button-DkTXS_IW.js'),true              ?[]:void 0).then((mod) => mod.Button);
__pwRegistry.initialize({ _home_runner_work_megazord_ui_megazord_ui_packages_ui_src_components_button_Button });

export { getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-CrNywVAj.js.map
